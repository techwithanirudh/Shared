...
# os.chdir(r'D:\Anirudh\\pythonprojects\\envs\\auto-py-to-exe36\\rock-paper-scissors-master')
...
while True:
    ret= True
    frame = cv2.imread('./images/rock.png')
    if not ret:
        continue
    ...
    cv2.rectangle(frame, (20, 100), (500, 500), (255, 255, 255), 2)
