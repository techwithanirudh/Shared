...
def TakeImages():         
    ...
    if(is_number(Id) and name.isalpha()):  
        ...
        harcascadePath = "D:/Anirudh/pythonprojects/sampleproject1/opencv-master/data/haarcascades/haarcascade_frontalface_default.xml" 
        ...
        while(True): 
            ...
            for (x, y, w, h) in faces:  
                ...
                cv2.imwrite( 
                    "data/4/TrainingImage/ "+name +"."+Id +'.'+ str( 
        ...
        row = [Id, name]  
        with open('data/4/UserDetails.csv', 'a+') as csvFile: 
...
def TrackImages(): 
    ...
    recognizer.read("data/4/Trainner.yml")  
    harcascadePath = "D:/Anirudh/pythonprojects/sampleproject1/opencv-master/data/haarcascades/haarcascade_frontalface_default.xml"
    faceCascade = cv2.CascadeClassifier(harcascadePath) 
    # getting the name from "userdetails.csv" 
    df = pd.read_csv("data/4/UserDetails.csv")   
    cam = cv2.VideoCapture(0) 
